...
describe('Directive: dashboard-grouped-layouts', function () {
    ...
    beforeEach(module('ui.dashboard', function($compileProvider){
        $compileProvider.directive('dashboardLayouts', function(){
            var def = {
                priority: 9999,
                terminal: true,
                restrict:'EAC',
    ...
    beforeEach(inject(function ($compile, _$rootScope_, _DashboardStorage_) {
        ...
        $rootScope.dashboardOptions = options = {
            ...
            defaultGroupLayouts: {
                ...
                layoutStates: {
                    'collection5id': {"storageId":"collection5id"}
                }
            },
    ...
    it('should set the first dashboard to active if there is not one already active', inject(function($compile) {
        angular.forEach(childScope.groups, function(group){
        ...
        angular.forEach(childScope.groups, function(group){
            ...
            angular.forEach(group.layoutGroups, function(layoutGroup){
                if (active) {
                    expect(layoutGroup.active).toBeFalsy();
                }
